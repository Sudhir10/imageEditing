...
#import "NKCropRectView.h"
#import "NKResizeControl.h"

@interface NKCropRectView ()<NKResizeControlViewDelegate>

@property (nonatomic) NKResizeControl *topLeftCornerView;
@property (nonatomic) NKResizeControl *topRightCornerView;
@property (nonatomic) NKResizeControl *bottomLeftCornerView;
@property (nonatomic) NKResizeControl *bottomRightCornerView;
@property (nonatomic) NKResizeControl *topEdgeView;
@property (nonatomic) NKResizeControl *leftEdgeView;
@property (nonatomic) NKResizeControl *bottomEdgeView;
@property (nonatomic) NKResizeControl *rightEdgeView;
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    for (UIView *subview in subviews) {
        if ([subview isKindOfClass:[NKResizeControl class]]) {
...
- (CGRect)cropRectMakeWithResizeControlView:(NKResizeControl *)resizeControlView
{
