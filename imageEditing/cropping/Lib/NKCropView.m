...
@interface NKCropView () <UIScrollViewDelegate, UIGestureRecognizerDelegate, NKCropRectViewDelegate>

@property (nonatomic) UIScrollView *scrollView;
@property (nonatomic) UIView *zoomingView;
@property (nonatomic) UIImageView *imageView;

@property (nonatomic) NKCropRectView *cropRectView;
...
- (void)commonInit
{
    ...
    self.cropRectView = [[NKCropRectView alloc] init];
...
- (CGRect)cappedCropRectInImageRectWithCropRectView:(NKCropRectView *)cropRectView
{
